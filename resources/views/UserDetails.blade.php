...
<div class="content" style="padding-top:20px">
    <div class="card" style="margin-top:70px">
        ...
        <div class="card-body">
            ...
            <p class="card-text" style="margin-bottom: 2px"><b>Email</b></p>
            <p>{{$users->email}}</p>

            <p class="card-text" style="margin-bottom: 2px"><b>Contact</b></p>
            <p>{{$users->contact}}</p>

            <p class="card-text" style="margin-bottom: 2px"><b>Address</b></p>
            <p>{{$users->address}}</p>

            <p class="card-text" style="margin-bottom: 2px"><b>Postal code</b></p>
            <p>{{$users->postal_code}}</p>

            <p class="card-text" style="margin-bottom: 2px"><b>Organization</b></p>
    ...
    @if($users->is_admin==1)
        <div class="card" style="margin-top:70px">
            ...
            <div class="card-body">
                ...
                @if($users->is_super_admin==1)
                    <p>Super Admin</p>
                @elseif($users->is_admin==1 and $users->is_super_admin==0)
                    <p>Admin</p>
                @endif
