...
<head>
    ...
    <style>
        .background_image {
            background-image: url(images-about/footer_image.png);
        }
    </style>
</head>
...
<body>
    ...
    <section id="sectionTop">
        <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top" id="navBar">
            <div class="container-fluid -justify">
                <a class="navbar-brand" href="#"><img style="padding-left: 1em;"
                        src="{{ URL('images-about/logo1Black.png') }}" width="185" height="48" /></a>
        ...
        <div class="container-fluid">
            <img src="{{ URL('images-about/main_pic.jpg') }}" class="img-fluid main_pic" alt="main_pic">
            ...
            <div class="row ">
                <div class="col-md custom-col">
                    <div class="cardview bg-projects">
                        <img src="{{ URL('images-about/check icon.png') }}" class="check_icon" alt="check_icon">
                ...
                <div class="col-md custom-col">
                    <div class="cardview bg-peoplebenefited">
                        <img src="{{ URL('images-about/people benefited.png') }}" class="peoplebenefited_icon"
                ...
                <div class="col-md custom-col">
                    <div class="cardview bg-amountraised">
                        <img src="{{ URL('images-about/amountraised.png') }}" class="amountraised_icon"
            ...
            <div class="aboutus d-flex flex-column align-items-center justify-content-center text-center">
                <div class="logo_box">
                    <img src="{{ URL('images-about/logo1Black.png') }}" class="img-fluid logo_pic" id="logo_pic"
                        alt="logo_pic">
                </div>
                ...
                <div class="row goals_row">
                    <div class="row">
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="slide">
                                <img src="{{ URL('images-about/Education and Empowerment.jpg') }}"
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="slide">
                                <img src="{{ URL('images-about/Healthcare and Well-being.jpg') }}"
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="slide">
                                <img src="{{ URL('images-about/Community Development.jpg') }}"
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="slide">
                                <img src="{{ URL('images-about/Disaster Relief and Rehabilitation.jpg') }}"
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="slide">
                                <img src="{{ URL('images-about/Environmental Conservation.png') }}"
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="slide">
                                <img src="{{ URL('images-about/Women and Child Welfare.jpg') }}"
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="slide">
                                <img src="{{ URL('images-about/Animal Welfare.jpg') }}" alt="Animal Welfare"
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            <div class="slide">
                                <img src="{{ URL('images-about/Elderly Support.jpg') }}" alt="Elderly Support"
                                    class="img-fluid goal_pic">
                                <div class="container">
                                    <p>Elderly Support</p>
                                </div>
                ...
                <div class="container text-center">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-md-6">
                            ...
                            <img src="{{ URL('images-about/help 1.png') }}" alt="help" class="help">
                            <p class="footer_text">Be a Member of who Building Bridges of Love and Support</p>
                            <div class="footer_buttons text-center">
                                <a href="#" class="btn btn-success donate_button">Donate Now</a>
                                <a href="#" class="btn btn-success volunteer_button">Volunteer</a>
                            </div>
