            ...
            <div class="collapse navbar-collapse " id="navbarText">
                ...
                <div class="" id="navbarText" style="float: inline-end;">
                    ...
                    <ul class="nav me-auto mb-2 mb-lg-0">
                        @auth
                            <li class="nav-item"><a class="nav-link active" aria-current="page" href="{{route('userprofile')}}"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
...
<section class="container">
    ...
    <div class="card" style="padding: 5px">
        <img src="{{ URL('resFiles/donationCategories/edu.jpg') }}" class="card-image car-1" style="width: auto; border-radius:10px"/>

        <div class="card-body1" style="width: auto; border-radius:10px">
            <img src="{{ URL('resFiles/donationCategories/mortarboard.png') }}" class="card-ico" />
            <h2>Educational Programs</h2>
            <p>Athahitha Organization empowers education through charitable donations, ensuring access to quality learning resources and opportunities for students in need.</p>
    ...
    <div class="card" style="padding: 5px">
        <img src="{{ URL('resFiles/donationCategories/hea.jpg') }}" class="card-image car-1" style="width: auto; border-radius:10px"/>
        <div class="card-body1" style="width: auto; border-radius:10px">
            <img src="{{ URL('resFiles/donationCategories/mortarboard.png') }}" class="card-ico" />
            <h2>Health Programs</h2>
            <p class="card-discription">Athahitha Organization: Empowering Health through Compassionate Donations for a Better Tomorrow.</p>
    ...
    <div class="card" style="padding: 5px">
        <img src="{{ URL('resFiles/donationCategories/nut.jpeg') }}" class="card-image car-1" style="width: auto; border-radius:10px"/>
        <div class="card-body1" style="width: auto; border-radius:10px">
            <img src="{{ URL('resFiles/donationCategories/mortarboard.png') }}" class="card-ico" />
            <h2>Nutrition Programs</h2>
            <p>Transforming lives through Athahitha Organization's nutrition programs, fostering holistic well-being and empowering individuals to thrive through mindful dietary
                 choices.</p>
    ...
    <div class="card" style="padding: 5px">
        <img src="{{ URL('resFiles/donationCategories/wat.png') }}" class="card-image car-1" style="width: auto; border-radius:10px"/>

        <div class="card-body1" style="width: auto; border-radius:10px">
            <img src="{{ URL('resFiles/donationCategories/drop.png') }}" class="card-ico" />
            <h2>Clean Water Programs</h2>
            <p>Empowering communities through Athahitha Organization's clean water programs for sustainable access to safe and potable water, 
                ensuring health and well-being.</p>
