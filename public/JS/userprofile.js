...
function openEditDialog(field) {
  ...
  switch (field) {
    ...
    case 'email':
      ...
      editMessage.textContent = "Your Athahitha Profile has been created based on your Email. Unfortunately you cannot edit your Email right now";
